...
import { selectConditional, deleteConditional } from '../../actions/ConditionalsActions'
import Input from './Input';
import DropDownMenu from './DropDownMenu';
import ToggleButtonGroup from './ToggleButtonGroup';

export class SingleConditionalSelector extends Component {
  constructor(props) {
    super(props);
  ...
  updateConditional = (newProps, isDefaultValue = false) => {
    ...
    if (!isDefaultValue || (isDefaultValue && this.state.value)) {
      this.props.selectConditional(conditional);
    }
  }
...
SingleConditionalSelector.propTypes = {
...
export default connect(mapStateToProps, { selectConditional, deleteConditional })(SingleConditionalSelector);
